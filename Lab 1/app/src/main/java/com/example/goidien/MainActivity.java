...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.editTextPhoneNumber = (EditText) this.findViewById(R.id.txtPhoneNumber);
        this.buttonCall = (Button) this.findViewById(R.id.btnCall);
